...
class Main_Windows(Tk):
    ...
    def update_student(self):
        try:
            ...
            student = Db_school_1.Student()
            student.insert(sql)
            showinfo("更新学生信息", "更新成功")
        except Exception as e:
            print('exception ',e)
            showinfo("更新学生信息", "更新失败")
    ...
    def view_student(self):
        try:
            ...
            #你来操作这个FFFFFFF
            f= open("sign_in_table.txt","a",encoding='utf-8')
            for line in ffffffff:
                f.write(json.dumps(line)+'\n')
            f.close()
            showinfo("查看签到信息","导出签到信息成功")
    ...
    def delete_student(self):
        try:
            ...
            sql ='delete from student where s_id = \'%s\''%get_input[0]

            print(sql)
            student.insert(sql)
            showinfo("删除学生信息","删除成功")
        except Exception as e:
            print('exception ', e)
            showinfo("删除学生信息","删除失败")
